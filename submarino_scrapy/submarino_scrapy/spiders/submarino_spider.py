...
class SubmarinoSpiderSpider(CrawlSpider):
    ...
    def get_uuid_param(self,response):
        ...
        try:
            ...
            #teste
            self.__init__(origem='GRU',destino='LHR',ano_saida='2013',mes_saida='04',dia_saida='17',ano_chegada='2013',mes_chegada='04',dia_chegada='22',user_browser="Mozilla/5.0 (Windows NT 6.1; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0")
        except:
